...
module.exports.run = async function ({ event, api }) {
  ...
  if (!mention[0]) return api.sendMessage("Please mention 1 person.", threadID, messageID);
    ...
    try {
      ...
      return api.sendMessage({ body: "ইস তোমাকে তো অন্য বেডা জড়িয়ে ধরল আমি বস রাকিব🤙 কে বলে দিব।😒🔪", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID);
    } catch (error) {
